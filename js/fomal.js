...
function createtime1() {
  var grt = new Date("11/28/2022 00:00:00"); //此处修改你的建站时间或者网站上线时间
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("11/28/2022 00:00:00");
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root {
    --default-bg: url(https://picdemo.cameliia.top/dm1.webp);
    --darkmode-bg: url(https://source.fomal.cc/img/movie.webp);
    --mobileday-bg: url(https://sourcebucket.s3.bitiful.net/img/mb4.webp);
...
<details class="folding-tag" cyan><summary> 查看适配手机的背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/Fomalhaut/img/mb4.webp)" class="pimgbox" onclick="changeBg('url(e)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://s1.vika.cn/space/2023/03/10/9add40cadb2a46409ce85744924ddc60)" class="pimgbox" onclick="changeBg('url(e)')"></a></div>
              </div>
            </details>
